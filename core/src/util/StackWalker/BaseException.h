...
#define SET_DEFAULT_HANDLER() SetUnhandledExceptionFilter(CBaseException::UnhandledExceptionFilter)
#define SET_DEFAULT_EXCEPTION() _set_se_translator(CBaseException::STF)
