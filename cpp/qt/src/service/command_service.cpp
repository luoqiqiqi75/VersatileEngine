...
//
// CommandServer::CommandServer(imol::ModuleObject* d) : _d(d)
// {
...
//     auto context_d = _context_map.value(session_ptr->hash_key(), imol::m().rootMobj());
//
//
...
//     _context_map[session_ptr->hash_key()] = imol::m().rootMobj();
// }
//
...
//
// void start(imol::ModuleObject* d)
// {
...
//     } else {
//         if (!d || d->isEmptyMobj()) {
//             d = imol::legacy::d(QStringLiteral("ve.server.command"));
//         }
